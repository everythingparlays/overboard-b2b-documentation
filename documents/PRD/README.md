...
Section 16 (Open Items) lists unresolved questions (export delivery mechanism, contest finalization authority, retention windows) — check there before assuming a gap is a documentation oversight rather than a known open decision.
